...
3. Create a new **API**
    ...
    1. Click on the **Create your first Resource Endpoint**
        ...
        <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint.jpg" width=45% height=45%>
     
    2. Fill in the name **salesorders_1_0_flogo_app__sync_orderId** and path **sync/{orderId}** and choose **TIBCO Cloud Mesh**
    
       <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint_002.jpg" width=45% height=45%>
       
    3. Click **Select Endpoint**
    
       <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint_003.jpg" width=45% height=45%>

    4. Select **SalesOrders**
    
       <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint_004.jpg" width=45% height=45%>
       
    5. Click the **Select** button 
    
       <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint_005.jpg" width=45% height=45%>
       
    6. Make sure the settings look like this and press the **Create** button to create your Endpoint
    
       <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_resource_endpoint_006.jpg" width=45% height=45%>
...
4. Create a new **API Package**
    ...
    3. Fill in the name **SalesOrderAPI** and click **Save and continue**
