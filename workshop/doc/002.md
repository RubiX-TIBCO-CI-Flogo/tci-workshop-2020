...
1. Navigate to the API specifications by clicking on the **Apps** menu item (or follow https://integration.cloud.tibco.com/applications).
     <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_flogo_app.jpg" width=30% height=30%>
    
2. Create a Flogo app by clicking on the **Create** button.
3. You van rename your created flogo app to **sales_orders_1_0_flogo_app**

    <img src="https://github.com/RubiX-TIBCO-CI-Flogo/tci-workshop-2020/blob/master/workshop/doc/images/create_flogo_app_001.jpg" width=30% height=30%>
...
1. Create a new skeleton flow **postSync_orderId_POST** by clicking Create.
    ![Flogo CreateFlow](images/create_flogo_flow.jpg) 
